...
4. 如果错误涉及"预算利用过低",建议通过升级酒店档次、增加特色餐厅、加景点门票等方式
   把 total 拉到档位下限(economy 50% / standard 70% / premium 85%)
5. 不要写 JSON,纯文本分点输出
...
- 预算利用过低,total=X 元 < 用户预算 Y 元 的 70%(standard 档),建议升级酒店到 ctx 中的'舒适酒店'"""
